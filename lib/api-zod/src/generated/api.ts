 ...
 */
export const ListJobListingsQueryParams = zod.object({
  status: zod.coerce.string().optional(),
  search: zod.coerce.string().optional(),
});
 ...
 */
export const GetJobBureauStatsResponse = zod.object({
  totalListings: zod.number(),
  openListings: zod.number(),
  closedListings: zod.number(),
  filledListings: zod.number(),
...
export const UpdateJobListingBody = zod
  .object({
  ...
  .describe("Partial update for a job listing. All fields optional.");
...
export const CreateJobApplicationBody = zod.object({
  ...
  cvDocuments: zod
    ...
    .optional(),
  status: zod
    .enum(["applied", "shortlisted", "interviewed", "placed", "rejected"])
    .optional(),
  notes: zod.string().optional(),
});
...
export const UpdateJobApplicationBody = zod
  .object({
    memberId: zod.string().nullish(),
    applicantName: zod.string().min(1).optional(),
    membershipId: zod.string().optional(),
  ...
  .describe("Partial update for a job application. All fields optional.");
