 ...
 */
export const getListFrfMembershipsUrl = (params?: ListFrfMembershipsParams) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/api/frf/memberships?${stringifiedParams}`
    : `/api/frf/memberships`;
};

export const listFrfMemberships = async (
  params?: ListFrfMembershipsParams,
  options?: RequestInit,
): Promise<FrfMembership[]> => {
  return customFetch<FrfMembership[]>(getListFrfMembershipsUrl(params), {
    ...options,
    method: "GET",
  });
};

export const getListFrfMembershipsQueryKey = (
  params?: ListFrfMembershipsParams,
) => {
  return [`/api/frf/memberships`, ...(params ? [params] : [])] as const;
};

export const getListFrfMembershipsQueryOptions = <
  TData = Awaited<ReturnType<typeof listFrfMemberships>>,
  TError = ErrorType<unknown>,
>(
  params?: ListFrfMembershipsParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof listFrfMemberships>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getListFrfMembershipsQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof listFrfMemberships>>
  > = ({ signal }) => listFrfMemberships(params, { signal, ...requestOptions });
...
export type ListFrfMembershipsQueryResult = NonNullable<
  Awaited<ReturnType<typeof listFrfMemberships>>
>;
export type ListFrfMembershipsQueryError = ErrorType<unknown>;

/**
 * @summary List FRF memberships
 */

export function useListFrfMemberships<
  TData = Awaited<ReturnType<typeof listFrfMemberships>>,
  TError = ErrorType<unknown>,
>(
  params?: ListFrfMembershipsParams,
  ...
  const queryOptions = getListFrfMembershipsQueryOptions(params, options);
 ...
 */
export const getCreateFrfMembershipUrl = () => {
  return `/api/frf/memberships`;
};

export const createFrfMembership = async (
  frfMembershipInput: FrfMembershipInput,
  options?: RequestInit,
): Promise<FrfMembership> => {
  return customFetch<FrfMembership>(getCreateFrfMembershipUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(frfMembershipInput),
  });
};

export const getCreateFrfMembershipMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof createFrfMembership>>,
    TError,
    { data: BodyType<FrfMembershipInput> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["createFrfMembership"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return createFrfMembership(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type CreateFrfMembershipMutationResult = NonNullable<
  Awaited<ReturnType<typeof createFrfMembership>>
>;
export type CreateFrfMembershipMutationBody = BodyType<FrfMembershipInput>;
export type CreateFrfMembershipMutationError = ErrorType<unknown>;

/**
 * @summary Create FRF membership (authenticated)
 */
export const useCreateFrfMembership = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getCreateFrfMembershipMutationOptions(options));
};

/**
 * @summary Public FRF membership application (no auth required)
 */
export const getApplyFrfMembershipUrl = () => {
  return `/api/frf/memberships/apply`;
};

export const applyFrfMembership = async (
  frfMembershipInput: FrfMembershipInput,
  options?: RequestInit,
): Promise<FrfMembership> => {
  return customFetch<FrfMembership>(getApplyFrfMembershipUrl(), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(frfMembershipInput),
...
export const getApplyFrfMembershipMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof applyFrfMembership>>,
    TError,
    { data: BodyType<FrfMembershipInput> },
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ["applyFrfMembership"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return applyFrfMembership(data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type ApplyFrfMembershipMutationResult = NonNullable<
  Awaited<ReturnType<typeof applyFrfMembership>>
>;
export type ApplyFrfMembershipMutationBody = BodyType<FrfMembershipInput>;
export type ApplyFrfMembershipMutationError = ErrorType<unknown>;

/**
 * @summary Public FRF membership application (no auth required)
 */
export const useApplyFrfMembership = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getApplyFrfMembershipMutationOptions(options));
};

/**
 * @summary Track FRF application by number or mobile (public)
 */
export const getTrackFrfMembershipUrl = (params?: TrackFrfMembershipParams) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0
    ? `/api/frf/memberships/track?${stringifiedParams}`
    : `/api/frf/memberships/track`;
};

export const trackFrfMembership = async (
  params?: TrackFrfMembershipParams,
  options?: RequestInit,
): Promise<FrfMembershipTrack[]> => {
  return customFetch<FrfMembershipTrack[]>(getTrackFrfMembershipUrl(params), {
    ...options,
    method: "GET",
  });
};

export const getTrackFrfMembershipQueryKey = (
  params?: TrackFrfMembershipParams,
) => {
  return [`/api/frf/memberships/track`, ...(params ? [params] : [])] as const;
};

export const getTrackFrfMembershipQueryOptions = <
  TData = Awaited<ReturnType<typeof trackFrfMembership>>,
  TError = ErrorType<unknown>,
>(
  params?: TrackFrfMembershipParams,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof trackFrfMembership>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey =
    queryOptions?.queryKey ?? getTrackFrfMembershipQueryKey(params);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof trackFrfMembership>>
  > = ({ signal }) => trackFrfMembership(params, { signal, ...requestOptions });
...
export type TrackFrfMembershipQueryResult = NonNullable<
  Awaited<ReturnType<typeof trackFrfMembership>>
>;
export type TrackFrfMembershipQueryError = ErrorType<unknown>;

/**
 * @summary Track FRF application by number or mobile (public)
 */

export function useTrackFrfMembership<
  TData = Awaited<ReturnType<typeof trackFrfMembership>>,
  TError = ErrorType<unknown>,
>(
  params?: TrackFrfMembershipParams,
  ...
  const queryOptions = getTrackFrfMembershipQueryOptions(params, options);
 ...
 */
export const getGetFrfMembershipStatsUrl = () => {
  return `/api/frf/memberships/stats`;
};

export const getFrfMembershipStats = async (
  options?: RequestInit,
): Promise<FrfMembershipStats> => {
  return customFetch<FrfMembershipStats>(getGetFrfMembershipStatsUrl(), {
    ...options,
    method: "GET",
  });
};

export const getGetFrfMembershipStatsQueryKey = () => {
  return [`/api/frf/memberships/stats`] as const;
};

export const getGetFrfMembershipStatsQueryOptions = <
  TData = Awaited<ReturnType<typeof getFrfMembershipStats>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
    Awaited<ReturnType<typeof getFrfMembershipStats>>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetFrfMembershipStatsQueryKey();

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getFrfMembershipStats>>
  > = ({ signal }) => getFrfMembershipStats({ signal, ...requestOptions });
...
export type GetFrfMembershipStatsQueryResult = NonNullable<
  Awaited<ReturnType<typeof getFrfMembershipStats>>
>;
export type GetFrfMembershipStatsQueryError = ErrorType<unknown>;

/**
 * @summary Get FRF membership statistics
 */

export function useGetFrfMembershipStats<
  TData = Awaited<ReturnType<typeof getFrfMembershipStats>>,
  TError = ErrorType<unknown>,
>(options?: {
  query?: UseQueryOptions<
  ...
  const queryOptions = getGetFrfMembershipStatsQueryOptions(options);
 ...
 */
export const getGetFrfMembershipUrl = (id: string) => {
  return `/api/frf/memberships/${id}`;
};

export const getFrfMembership = async (
  id: string,
  options?: RequestInit,
): Promise<FrfMembershipDetail> => {
  return customFetch<FrfMembershipDetail>(getGetFrfMembershipUrl(id), {
    ...options,
    method: "GET",
  });
};

export const getGetFrfMembershipQueryKey = (id: string) => {
  return [`/api/frf/memberships/${id}`] as const;
};

export const getGetFrfMembershipQueryOptions = <
  TData = Awaited<ReturnType<typeof getFrfMembership>>,
  TError = ErrorType<unknown>,
>(
  id: string,
  options?: {
    query?: UseQueryOptions<
      Awaited<ReturnType<typeof getFrfMembership>>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customFetch>;
  ...
  const queryKey = queryOptions?.queryKey ?? getGetFrfMembershipQueryKey(id);

  const queryFn: QueryFunction<
    Awaited<ReturnType<typeof getFrfMembership>>
  > = ({ signal }) => getFrfMembership(id, { signal, ...requestOptions });
...
export type GetFrfMembershipQueryResult = NonNullable<
  Awaited<ReturnType<typeof getFrfMembership>>
>;
export type GetFrfMembershipQueryError = ErrorType<unknown>;

/**
 * @summary Get a FRF membership with dependents
 */

export function useGetFrfMembership<
  TData = Awaited<ReturnType<typeof getFrfMembership>>,
  TError = ErrorType<unknown>,
>(
  id: string,
  ...
  const queryOptions = getGetFrfMembershipQueryOptions(id, options);
 ...
 */
export const getUpdateFrfMembershipUrl = (id: string) => {
  return `/api/frf/memberships/${id}`;
};

export const updateFrfMembership = async (
  id: string,
  frfMembershipInput: FrfMembershipInput,
  options?: RequestInit,
): Promise<FrfMembership> => {
  return customFetch<FrfMembership>(getUpdateFrfMembershipUrl(id), {
    ...options,
    method: "PATCH",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(frfMembershipInput),
...
export const getUpdateFrfMembershipMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updateFrfMembership>>,
    TError,
    { id: string; data: BodyType<FrfMembershipInput> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["updateFrfMembership"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return updateFrfMembership(id, data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type UpdateFrfMembershipMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateFrfMembership>>
>;
export type UpdateFrfMembershipMutationBody = BodyType<FrfMembershipInput>;
export type UpdateFrfMembershipMutationError = ErrorType<unknown>;

/**
 * @summary Update FRF membership
 */
export const useUpdateFrfMembership = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getUpdateFrfMembershipMutationOptions(options));
};

/**
 * @summary Delete FRF membership
 */
export const getDeleteFrfMembershipUrl = (id: string) => {
  return `/api/frf/memberships/${id}`;
};

export const deleteFrfMembership = async (
  id: string,
  options?: RequestInit,
): Promise<void> => {
  return customFetch<void>(getDeleteFrfMembershipUrl(id), {
    ...options,
    method: "DELETE",
  });
};

export const getDeleteFrfMembershipMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteFrfMembership>>,
    TError,
    { id: string },
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ["deleteFrfMembership"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return deleteFrfMembership(id, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type DeleteFrfMembershipMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteFrfMembership>>
>;

export type DeleteFrfMembershipMutationError = ErrorType<unknown>;

/**
 * @summary Delete FRF membership
 */
export const useDeleteFrfMembership = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getDeleteFrfMembershipMutationOptions(options));
};

/**
 * @summary Add a dependent to FRF membership
 */
export const getAddFrfDependentUrl = (id: string) => {
  return `/api/frf/memberships/${id}/dependents`;
};

export const addFrfDependent = async (
  id: string,
  frfDependentInput: FrfDependentInput,
  options?: RequestInit,
): Promise<FrfDependent> => {
  return customFetch<FrfDependent>(getAddFrfDependentUrl(id), {
    ...options,
    method: "POST",
    headers: { "Content-Type": "application/json", ...options?.headers },
    body: JSON.stringify(frfDependentInput),
  });
};

export const getAddFrfDependentMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof addFrfDependent>>,
    TError,
    { id: string; data: BodyType<FrfDependentInput> },
    TContext
  >;
  request?: SecondParameter<typeof customFetch>;
}): UseMutationOptions<
  ...
  TContext
> => {
  const mutationKey = ["addFrfDependent"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return addFrfDependent(id, data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type AddFrfDependentMutationResult = NonNullable<
  Awaited<ReturnType<typeof addFrfDependent>>
>;
export type AddFrfDependentMutationBody = BodyType<FrfDependentInput>;
export type AddFrfDependentMutationError = ErrorType<unknown>;

/**
 * @summary Add a dependent to FRF membership
 */
export const useAddFrfDependent = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getAddFrfDependentMutationOptions(options));
};

/**
 * @summary Delete a FRF dependent
 */
export const getDeleteFrfDependentUrl = (id: string) => {
  return `/api/frf/dependents/${id}`;
};

export const deleteFrfDependent = async (
  id: string,
  options?: RequestInit,
): Promise<void> => {
  return customFetch<void>(getDeleteFrfDependentUrl(id), {
    ...options,
    method: "DELETE",
  });
};

export const getDeleteFrfDependentMutationOptions = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteFrfDependent>>,
    TError,
    { id: string },
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ["deleteFrfDependent"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return deleteFrfDependent(id, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type DeleteFrfDependentMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteFrfDependent>>
>;

export type DeleteFrfDependentMutationError = ErrorType<unknown>;

/**
 * @summary Delete a FRF dependent
 */
export const useDeleteFrfDependent = <
  TError = ErrorType<unknown>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  TContext
> => {
  return useMutation(getDeleteFrfDependentMutationOptions(options));
};
