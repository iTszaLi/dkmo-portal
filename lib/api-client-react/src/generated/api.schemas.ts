...
export interface FrfDependentInput {
  /** @minLength 1 */
  fullName: string;
  relation?: string;
  /** @nullable */
...
export interface FrfMembership {
  id: string;
  frfNumber: string;
  /** @nullable */
  memberId?: string | null;
...
export type FrfMembershipDetail = FrfMembership & {
  dependents: FrfDependent[];
};

export interface FrfMembershipInput {
  /** @nullable */
  memberId?: string | null;
  /** @minLength 1 */
  fullName: string;
...
export interface FrfMembershipStats {
  total: number;
  pending: number;
  approved: number;
  rejected: number;
...
export interface FrfMembershipTrack {
  frfNumber: string;
  fullName: string;
  status: string;
  /** @nullable */
...
export type ListFrfMembershipsParams = {
  search?: string;
  status?: string;
};
