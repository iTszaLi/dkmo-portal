...
export const membersTable = pgTable("members", {
  ...
  ppName: text("pp_name").notNull().default(""),
  ...
  legacyEntryDate: text("legacy_entry_date").notNull().default(""),
  district: text("district").notNull().default(""),
  legacyMemberStatus: text("legacy_member_status").notNull().default(""),
  referredBy: text("referred_by").notNull().default(""),
  availContribution: text("avail_contribution").notNull().default(""),
